...
import 'study_cards_model.dart';
export 'study_cards_model.dart';

class StudyCardsWidget extends StatefulWidget {
  const StudyCardsWidget({super.key});

  @override
  State<StudyCardsWidget> createState() => _StudyCardsWidgetState();
}

class _StudyCardsWidgetState extends State<StudyCardsWidget>
    with TickerProviderStateMixin {
  late StudyCardsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StudyCardsModel());
