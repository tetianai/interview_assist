...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFFF7A52B);
  late Color tertiary = const Color(0xFF6DB7E6);
  ...
  late Color accent2 = const Color(0xFFFFC3A0);
  late Color accent3 = const Color(0xFFFFE66D);
  late Color accent4 = const Color(0xFF7BDFF2);
